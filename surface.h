...
//    std::array<std::array<Node *, number_of_nodes_in_x>, number_of_nodes_in_y> its_surface;
public:
    ...
    void desorption ();
    void initial_distribution (unsigned int amount_of_particles, unsigned int new_state);
    void migration ();
